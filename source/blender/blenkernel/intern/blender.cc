...
static void blender_version_init()
{
  ...
  /* ---------------------------------------------------------------------------
   * Falcon Render の表示名 (2026-08-25 作者指示)
   *
   ...
   * --------------------------------------------------------------------------- */
  /* ★2026-09-01 作者指示: 画面に出る名前は**2つだけ**。
   *
   *   「Falcon Engine」          = リアルタイムで進む最新。**版を名乗らない**
   *   「Falcon Engine v0.5 demo」= 配布向けに調整したデモ(2026-09-19 作者: 起動する時に取り違えないよう名前を分ける)
   *

...
- **macOS**: あまり推奨しません。ビルドできても機能面の制限が多く(上と同じ理由)、作者が環境を持っていないため確認もできません。

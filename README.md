...
![VSEヘッダーの新しいボタンとチャンネル入れ替え](docs/images/2026-09-23-vse/header-controls.png)
...
- **再生中の不具合修正**: Strip を削除すると落ちる不具合・再生開始直後だけ GPU が正しく使われない不具合
  ...
  ★使い方は画像付きで [docs/vse-2026-09-23-updates.md](docs/vse-2026-09-23-updates.md) にまとめてあります。
